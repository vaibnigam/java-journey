...
//      que13(sc);
    ...
    private static void que13(Scanner sc) {
        ...
        // 13. User se ek positive number maango, jab tak negative number de tab tak
        // error dikhake dobara pucho.
    ...
    private static void que12(Scanner sc) {
        ...
        // 12. Ek password validation loop banao — jab tak user sahi password na de
        // (max 3 attempts ka tracking bhi karo, counter variable use karke).
    ...
    private static void que10(Scanner sc) {
        ...
        // 10. Armstrong number check karo while loop se
        // (jaise 153 = 1³+5³+3³).
    ...
    private static void que8(Scanner sc) {
        ...
        // 8. Check karo ek number palindrome hai ya nahi
        // (while loop se, reverse wale logic ka use karke).
    ...
    private static void que7(Scanner sc) {
        ...
        // 7. Ek number reverse karo while loop use karke
        // (jaise 1234 → 4321).
    ...
    private static void que6(Scanner sc) {
        ...
        // 6. 1 se N tak kitne numbers 3 se divisible hain,
        // unki count nikaalo while loop se.
    ...
    private static void que5(Scanner sc) {
        ...
        // 5. Ek number diya hai, uske digits ka sum while loop se nikaalo
        // (jaise 4527 → 4+5+2+7).
    ...
    private static void que4(Scanner sc) {
        ...
        // 4. User se numbers lo jab tak woh -1 na de (sentinel value),
        // sabka sum aur average nikaalo.
    ...
    private static void que2() {
        ...
        // 2. 50 se 1 tak reverse counting print karo
        // (decrement wala while loop).
